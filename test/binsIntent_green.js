...
describe("Testing an Intent request for binsIntent - GREEN", function() {
  ...
  "version": "1.0"
	...
	describe("The response is structurally correct for Alexa Speech Services", function() {
		...
		it("should have speechOutput from the getDialogue function bins > green array", function() {
			expect(speechResponse.response.outputSpeech.ssml).to.equal(dialogue.ssmlIfy(dialogue.pickPhrase(dialogue.phrases.bins.green)));
		})
